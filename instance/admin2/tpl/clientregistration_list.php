<div class="listAffiliates actionItem">
    <div class="panel panel-default">
        <div class="panel-heading">
            <div style="float:left;padding-top:8px"><b>List of Client Registration</b></div> 
		...
		?>
			...
			<?php foreach ($reg as $each_reg): ?>
				...
				<td>
				    <a href="<?php print _U ?>client_registration/edit/<?php print $each_reg['id']; ?>"><i class="glyphicon glyphicon-edit" title="Edit"></i></a>
				    <a href="javascript:void(0);" onclick="return Deleteclientregistration('client_registration/delete/<?php print $each_reg['id']; ?>')"><i class="glyphicon glyphicon-trash" title="Delete"></i></a>
